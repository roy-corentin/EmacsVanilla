...
(use-package general
  ...
  (cr/leader-keys
    ...
    "f V" '(cr/project-open-file-other-window :which-key "Find file in other window")
    "f S" '(cr/project-open-file-below-window :which-key "Find file in new below window")
    "f r" '(consult-recent-file :which-key "Recentf")
    "f R" '(bufferfile-rename :which-key "Rename file")
    "f d" '(bufferfile-delete :which-key "Delete file")
    "f c" '(bufferfile-copy :which-key "Copy file")
    ...
    "w C-s" '(cr/split-window-below-and-follow :which-key "Split window and follow")
    "w v" '(split-window-right :which-key "Vsplit window")
    "w V" '(cr/split-window-right-and-follow :which-key "Vsplit window and follow")
    "w C-v" '(cr/split-window-right-and-follow :which-key "Vsplit window and follow")
    ...
    "t O" '(kithar-mode :which-key "CR Olivetti")
    ...
    "TAB d" '(cr/tab-close :which-key "Kill buffers of project")
