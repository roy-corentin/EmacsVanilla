...
(use-package eglot
  ...
  :config
  (add-to-list 'eglot-server-programs '((elixir-mode elixir-ts-mode heex-ts-mode) "elixir-ls"))
  (add-to-list 'eglot-server-programs '((ruby-mode ruby-ts-mode rbs-mode) "bundle" "exec" "ruby-lsp"))
