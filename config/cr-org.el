...
(use-package org
  ...
  (prettify-symbols-alist '(("#+PROPERTY:" . "") ("#+property:" . "")
                            ...
                            ("#+begin_src" . "↦") ("#+BEGIN_SRC" . "↦")
                            ("#+end_src" . "⇤") ("#+END_SRC" . "⇤")))
  (org-capture-templates '(("f" "Freelance" entry (file+headline "~/org/freelance_syadem_todo.org" cr/select-freelance-todo-healine)
                            "* TODO %?\n  %i\n  %l")
                           ("v" "Vie" entry (file+headline "~/org/vie_syadem_todo.org" cr/select-vie-todo-healine)
                            "* TODO %?\n  %i\n  %l")
